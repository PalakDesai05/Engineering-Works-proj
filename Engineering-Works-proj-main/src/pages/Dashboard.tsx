...
export default function Dashboard() {
  ...
  useEffect(() => {
    dashboardApi.summary()
      .then((res) => {
        if (res.success) {
          setStats({
            total:   res.data.workers.active,
            present: res.data.attendance.present_today,
            absent:  res.data.attendance.absent_today,
          });
        }
      })
      .catch(console.error)
  ...
  const summaryCards = [
    ...
    },
    {
      ...
      iconBg: '#fee2e2', iconColor: '#dc2626', valueColor: '#dc2626',
    ...
    },
    {
      ...
      value: stats.total,
      icon: <Users size={20} />,
      iconBg: '#EEEDFE', iconColor: '#534AB7', valueColor: '#26215C',
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        {summaryCards.map((card) => (
          <div key={card.label} className="card-frost p-6">
        ...
        <div className="card p-6 mb-10">
          ...
          <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
            <div
              ...
              style={{ width: `${(stats.present / stats.total) * 100}%`, backgroundColor: '#534AB7' }}
            />
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          ...
          <div className="space-y-2 mt-3">
            ...
            <div className="flex items-center gap-2.5">
              <span className="w-[6px] h-[6px] rounded-full bg-green-500 inline-block flex-shrink-0" />
              <span className="text-[12px] text-gray-500">API connected</span>
            </div>
          </div>
        </div>
      </div>
